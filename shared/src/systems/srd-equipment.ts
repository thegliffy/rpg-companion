...
export interface SrdGear {
  ...
  cost: string;
  weight: number;
  /** Real constituent items, for the equipment packs (Burglar's, Explorer's, etc.) -- each
   * itemId must resolve in SRD_GEAR (self-referential; packs never contain other packs). */
...
export const SRD_GEAR: SrdGear[] = [
  ...
  { id: "alchemists-supplies", name: "Alchemist's supplies", cost: "50 gp", weight: 8 },
  ...
  { id: "bagpipes", name: "Bagpipes", cost: "30 gp", weight: 6 },
  ...
  { id: "brewers-supplies", name: "Brewer's supplies", cost: "20 gp", weight: 9 },
  { id: "bucket", name: "Bucket", cost: "5 cp", weight: 2 },
  {
    ...
    contents: [
      ...
      { itemId: "ball-bearings-bag-of-1000", quantity: 1 },
      { itemId: "string-10-feet", quantity: 1 },
      { itemId: "bell", quantity: 1 },
      { itemId: "candle", quantity: 5 },
      { itemId: "crowbar", quantity: 1 },
      { itemId: "hammer", quantity: 1 },
      { itemId: "piton", quantity: 10 },
      { itemId: "lantern-hooded", quantity: 1 },
      { itemId: "oil-flask", quantity: 2 },
      { itemId: "rations-1-day", quantity: 5 },
      { itemId: "tinderbox", quantity: 1 },
      { itemId: "waterskin", quantity: 1 },
      { itemId: "rope-hempen-50-feet", quantity: 1 },
    ],
  },
  { id: "calligraphers-supplies", name: "Calligrapher's supplies", cost: "10 gp", weight: 5 },
  { id: "caltrops", name: "Caltrops", cost: "5 cp", weight: 2 },
  { id: "candle", name: "Candle", cost: "1 cp", weight: 0 },
  { id: "carpenters-tools", name: "Carpenter's tools", cost: "8 gp", weight: 6 },
  { id: "cartographers-tools", name: "Cartographer's tools", cost: "15 gp", weight: 6 },
  ...
  { id: "cobblers-tools", name: "Cobbler's tools", cost: "5 gp", weight: 5 },
  { id: "component-pouch", name: "Component pouch", cost: "25 gp", weight: 2 },
  { id: "cooks-utensils", name: "Cook's utensils", cost: "1 gp", weight: 8 },
  ...
  { id: "dice-set", name: "Dice set", cost: "1 sp", weight: 0 },
  {
    id: "diplomats-pack",
    ...
    contents: [
      ...
      { itemId: "ink-1-ounce-bottle", quantity: 1 },
      { itemId: "ink-pen", quantity: 1 },
      { itemId: "lamp", quantity: 1 },
      { itemId: "oil-flask", quantity: 2 },
      { itemId: "paper-one-sheet", quantity: 5 },
      { itemId: "perfume-vial", quantity: 1 },
      { itemId: "sealing-wax", quantity: 1 },
      { itemId: "soap", quantity: 1 },
    ],
  },
  { id: "disguise-kit", name: "Disguise Kit", cost: "25 gp", weight: 3 },
  { id: "dragonchess-set", name: "Dragonchess set", cost: "1 gp", weight: 0.5 },
  { id: "drum", name: "Drum", cost: "6 gp", weight: 3 },
  { id: "dulcimer", name: "Dulcimer", cost: "25 gp", weight: 10 },
  {
    id: "dungeoneers-pack",
  ...
  { id: "emblem", name: "Emblem", cost: "5 gp", weight: 0 },
  {
    ...
    contents: [
      ...
      { itemId: "clothes-costume", quantity: 2 },
      { itemId: "candle", quantity: 5 },
      { itemId: "rations-1-day", quantity: 5 },
      { itemId: "waterskin", quantity: 1 },
  ...
  { id: "flute", name: "Flute", cost: "2 gp", weight: 1 },
  { id: "forgery-kit", name: "Forgery Kit", cost: "15 gp", weight: 5 },
  { id: "glassblowers-tools", name: "Glassblower's tools", cost: "30 gp", weight: 5 },
  ...
  { id: "horn", name: "Horn", cost: "3 gp", weight: 2 },
  ...
  { id: "jewelers-tools", name: "Jeweler's tools", cost: "25 gp", weight: 2 },
  ...
  { id: "playing-card-set", name: "Playing card set", cost: "5 sp", weight: 0 },
  ...
  { id: "potters-tools", name: "Potter's tools", cost: "10 gp", weight: 3 },
  { id: "pouch", name: "Pouch", cost: "5 sp", weight: 1 },
  {
    ...
    contents: [
      ...
      { itemId: "block-of-incense", quantity: 2 },
      { itemId: "censer", quantity: 1 },
      { itemId: "vestments", quantity: 1 },
      { itemId: "rations-1-day", quantity: 2 },
      { itemId: "waterskin", quantity: 1 },
    ],
  },
  ...
  { id: "smiths-tools", name: "Smith's tools", cost: "20 gp", weight: 8 },
  ...
  { id: "thieves-tools", name: "Thieves' Tools", cost: "25 gp", weight: 1 },
  { id: "three-dragon-ante-set", name: "Three-Dragon Ante set", cost: "1 gp", weight: 0 },
  { id: "tinderbox", name: "Tinderbox", cost: "5 sp", weight: 1 },
  { id: "tinkers-tools", name: "Tinker's tools", cost: "50 gp", weight: 10 },
