...
export const SRD_INVOCATIONS: SrdInvocation[] = [
  { id: "eldritch-invocation-agonizing-blast", name: "Agonizing Blast", description: "When you cast eldritch blast, add your Charisma modifier to the damage it deals on a hit.", prereqLevel: 2, prereqSpell: "Eldritch Blast" },
  { id: "eldritch-invocation-armor-of-shadows", name: "Armor of Shadows", description: "You can cast mage armor on yourself at will, without expending a spell slot or material components.", prereqLevel: 2 },
  { id: "eldritch-invocation-beast-speech", name: "Beast Speech", description: "You can cast speak with animals at will, without expending a spell slot.", prereqLevel: 2 },
  { id: "eldritch-invocation-beguiling-influence", name: "Beguiling Influence", description: "You gain proficiency in the Deception and Persuasion skills.", prereqLevel: 2 },
  ...
  { id: "eldritch-invocation-devils-sight", name: "Devil's Sight", description: "You can see normally in darkness, both magical and nonmagical, to a distance of 120 feet.", prereqLevel: 2 },
  { id: "eldritch-invocation-eldritch-sight", name: "Eldritch Sight", description: "You can cast detect magic at will, without expending a spell slot.", prereqLevel: 2 },
  { id: "eldritch-invocation-eldritch-spear", name: "Eldritch Spear", description: "When you cast eldritch blast, its range is 300 feet.", prereqLevel: 2, prereqSpell: "Eldritch Blast" },
  ...
  { id: "eldritch-invocation-fiendish-vigor", name: "Fiendish Vigor", description: "You can cast false life on yourself at will as a 1st-level spell, without expending a spell slot or material components.", prereqLevel: 2 },
  ...
  { id: "eldritch-invocation-mask-of-many-faces", name: "Mask of Many Faces", description: "You can cast disguise self at will, without expending a spell slot.", prereqLevel: 2 },
  { id: "eldritch-invocation-misty-visions", name: "Misty Visions", description: "You can cast silent image at will, without expending a spell slot or material components.", prereqLevel: 2 },
  { id: "eldritch-invocation-repelling-blast", name: "Repelling Blast", description: "When you hit a creature with eldritch blast, you can push the creature up to 10 feet away from you in a straight line.", prereqLevel: 2, prereqSpell: "Eldritch Blast" },
  ...
  { id: "eldritch-invocation-ascendant-step", name: "Ascendant Step", description: "You can cast levitate on yourself at will, without expending a spell slot or material components.", prereqLevel: 9 },
  ...
  { id: "eldritch-invocation-otherworldly-leap", name: "Otherworldly Leap", description: "You can cast jump on yourself at will, without expending a spell slot or material components.", prereqLevel: 9 },
  { id: "eldritch-invocation-whispers-of-the-grave", name: "Whispers of the Grave", description: "You can cast speak with dead at will, without expending a spell slot.", prereqLevel: 9 },
  ...
  { id: "eldritch-invocation-master-of-myriad-forms", name: "Master of Myriad Forms", description: "You can cast alter self at will, without expending a spell slot.", prereqLevel: 15 },
  { id: "eldritch-invocation-visions-of-distant-realms", name: "Visions of Distant Realms", description: "You can cast arcane eye at will, without expending a spell slot.", prereqLevel: 15 },
